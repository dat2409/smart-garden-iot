...
-- AddForeignKey
ALTER TABLE `Tour` ADD CONSTRAINT `Tour_destinationName_fkey` FOREIGN KEY (`destinationName`) REFERENCES `Destination`(`name`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Tour` ADD CONSTRAINT `Tour_planName_fkey` FOREIGN KEY (`planName`) REFERENCES `Plan`(`name`) ON DELETE RESTRICT ON UPDATE CASCADE;
